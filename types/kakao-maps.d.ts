declare global {
  namespace kakao.maps {
    ...
    class ZoomControl {}
    class Polyline { constructor(options: { path: LatLng[]; strokeWeight: number; strokeColor: string; strokeOpacity: number; strokeStyle: string }); setMap(map: Map | null): void; }
    class CustomOverlay { constructor(options: { position: LatLng; content: HTMLElement; xAnchor?: number; yAnchor?: number }); setMap(map: Map | null): void; }
